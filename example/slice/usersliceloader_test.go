...
func TestUserLoader(t *testing.T) {
	...
	dl := slice.NewUserSliceLoader(slice.UserSliceLoaderConfig{
		Fetch: func(contexts []context.Context, keys []string) (users [][]example.User, errors []error) {
			mu.Lock()
	...
	t.Run("fetch concurrent data", func(t *testing.T) {
		...
		t.Run("load many users", func(t *testing.T) {
			t.Parallel()
			u, err := dl.LoadAll(context.Background(), []string{"2", "10", "20", "4"})
	...
	t.Run("fetch more", func(t *testing.T) {
		...
		t.Run("load many users", func(t *testing.T) {
			t.Parallel()
			u, err := dl.LoadAll(context.Background(), []string{"2", "4"})
	...
	t.Run("fetch partial", func(t *testing.T) {
		...
		t.Run("load all", func(t *testing.T) {
			t.Parallel()
			u, err := dl.LoadAll(context.Background(), []string{"1", "4", "10", "9", "5"})
	...
	t.Run("load all thunk", func(t *testing.T) {
		thunk1 := dl.LoadAllThunk(context.Background(), []string{"5", "6"})
		thunk2 := dl.LoadAllThunk(context.Background(), []string{"6", "60"})
